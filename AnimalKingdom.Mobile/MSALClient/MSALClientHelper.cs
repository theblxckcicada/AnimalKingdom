...
namespace AnimalKingdom.Mobile.MSALClient
{
    ...
    public class MSALClientHelper
    {
        ...
        public static readonly KeyValuePair<string, string> LinuxKeyRingAttr2 = new("ProductGroup", "Contoso");
        ...
        {
            PublicClientApplicationBuilder = PublicClientApplicationBuilder.Create(AzureADB2CConfig.ClientId)
